...
define("public/utils", ["require", "exports", "public/vdom"], function (require, exports, vdom_1) {
	...
	var Utils = (function () {
		...
		Utils.prototype.ajaxSetup = function () {
			...
			var request_token_cookie = bt.get_cookie(request_token_key);
		...
		Utils.prototype.$checkWeakCipher = function (paw) {
			var checks = [
				...
				'password',
				'qwerqwer',
			], pchecks = 'abcdefghijklmnopqrstuvwxyz1234567890', lower = paw.toLowerCase(), isError = '';
				...
				$.ajaxSetup({
					...
					error: function (XHR) { return __awaiter(_this_1, void 0, void 0, function () {
						...
						return __generator(this, function (_a) {
							switch (_a.label) {
								case 0:
									resText = XHR.responseText, resStatus = XHR.status, monitorStr = [
										'/static/favicon.ico',
									...
									if (typeof resText == 'string' &&
										monitorStr.some(function (item) { return resText.indexOf(item) > -1; }))
						...
						return __generator(this, function (_a) {
							switch (_a.label) {
								case 0:
									...
									if (!(typeof rdata.msg === 'string' &&
										rdata.msg.indexOf('CSRF校验失败，请重新登录面板') > -1)) return [3, 2];
					...
					switch (_a.label) {
						case 0:
							...
							if (typeof param === 'object' &&
								param.hasOwnProperty('loading') &&
								param.hasOwnProperty('msg'))
								(config = param), (param = {});
		...
		Utils.prototype.$msg = function (param, param1) {
			...
			if (typeof param === 'object') {
				...
				if (typeof msg == 'string' && typeof param.status === 'boolean') {
					config.icon =
						typeof param.status === 'boolean' ? (param.status ? 1 : 2) : 1;
				}
			}
		...
		Utils.prototype.$success = function (msg) {
			return this.$msg({ msg: msg, icon: 1 });
		};
								...
								content: {
									...
									template: function () {
										return ((0, snabbdom_2.jsx)("div", { class: this.$class('pd20 bt-form libLogin') },
											...
											(0, snabbdom_2.jsx)("div", { class: { line: true } }, this.$input({
												model: 'username',
												placeholder: '手机',
												disabled: this.usernameBtnDisabled,
											})),
											(0, snabbdom_2.jsx)("div", { class: { line: true } }, this.$input({
												model: 'password',
												type: 'password',
												placeholder: '密码',
												keyup: this.bindUserInfo.bind(this),
												disabled: this.usernameBtnDisabled,
											})),
											(0, snabbdom_2.jsx)("div", { class: { line: true, verifyCodeView: true }, style: { display: this.verifyStatus ? 'block' : 'none' } },
												...
												(0, snabbdom_2.jsx)("div", { class: { 'pull-right': true } },
													(0, snabbdom_2.jsx)("span", { class: {
															getVerifyCode: true,
															active: this.verifyBtnDisabled,
														}, style: { top: '5px' }, on: { click: this.cutVerifyViewStatus.bind(this) } }, this.tipsText))),
											(0, snabbdom_2.jsx)("div", { class: { line: true } }, this.$button({
												className: 'login-button',
												title: '绑定账号',
												click: this.bindUserInfo.bind(this),
												width: '100%',
												height: '40px',
											})),
											(0, snabbdom_2.jsx)("p", { class: { 'text-right': true } },
												...
												this.$link({
													title: '未有账号，去注册',
													href: 'https://www.bt.cn/register.html',
												}))));
									},
									methods: {
												...
												return __generator(this, function (_b) {
													switch (_b.label) {
														case 0:
															...
															return [4, that_1.$verifySubmitList([
																[!that_1.$checkPhone(username), '请输入手机号'],
																[!password, '请输入密码'],
															])];
														case 1:
															_b.sent();
														...
														case 2:
															_b.sent();
															param = { username: rsa.encrypt_public(username), password: rsa.encrypt_public(password) };
															if (this.verifyStatus) {
																param['code'] = this.verifyCode;
																param['token'] = this.token;
															}
															return [4, that_1.$request('GetAuthToken', param, {
																msg: false,
															})];
														case 3:
															rdata = _b.sent();
												...
												return __generator(this, function (_a) {
													switch (_a.label) {
														case 0:
															...
															return [4, that_1.$request('GetBindCode', {
							...
							return [4, this.$open({
								...
								title: type === 'all'
									...
									: type === 'file'
										...
										: lan.bt.dir,
								closeBtn: 2,
								content: "<div class='changepath'><div class='path-top'><button type='button' id='btn_back' class='btn btn-default btn-sm'><span class='glyphicon glyphicon-share-alt'></span> " +
									lan['public']['return'] +
									"</button><div class='place' id='PathPlace'>" +
									lan.bt.path +
									"：<span></span></div></div><div class='path-con'><div class='path-con-left'><dl><dt id='changecomlist' ></dt></dl></div><div class='path-con-right'><ul class='default' id='computerDefautl'></ul><div class='file-list divtable'><table class='table table-hover' style='border:0 none'><thead><tr class='file-list-head'><th width='5%'></th><th width='38%'>" +
									lan.bt.filename +
									"</th><th width='24%'>" +
									lan.bt.etime +
									"</th><th width='8%'>" +
									...
									lan.bt.adddir +
									"</button><button type='button' class='btn btn-danger btn-sm mr5 closeLayer'>" +
									lan['public'].close +
